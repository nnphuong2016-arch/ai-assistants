...
> **Bắt buộc đọc lại TỪNG NỘI DUNG sau khi viết xong — áp dụng cho MỌI Factory sinh nội dung văn
> bản** (xác nhận 06/08/2026, bổ sung 07/08/2026, mở rộng phạm vi ra ngoài SEO 11/08/2026): viết
> xong một bài/kịch bản/post là chưa xong việc, dù là bài SEO, kịch bản video, bài Facebook, post
> Zalo/Newsletter, hay trả lời bình luận — đây là bước KHÔNG được bỏ qua, không được coi là tùy
> chọn, không được lướt nhanh cho có. Phải đọc lại toàn bộ nội dung đó, đối chiếu từng điểm với
> đúng file `*_checklist.md` của Factory đang làm (mục 0 Quick Fail + các mục còn lại của
> `seo_checklist.md`, hoặc `community_checklist.md`/checklist tương ứng), và tự tìm xem có sai
> sót gì không: tên/tiêu đề có đúng nguyên văn backlog không (xem Bước 5.A với SEO), số thứ tự
> file có đúng không, độ dài có đúng khoảng quy định không, Body bản thuần chữ có còn sót ký tự
> định dạng không, có đoạn nào lặp ý/lan man/nghe rõ là AI viết không, có disclaimer nào bị lặp
> lại 2 lần trong cùng một bài không (đã từng xảy ra ở toàn bộ 50 bài SEO đầu tiên, xem cảnh báo
> "Không lặp disclaimer" ở Bước 5.A).
>
> **Không dừng lại ở việc bắt lỗi — phải chủ động sửa lại cho hay hơn, hấp dẫn hơn**: đọc tiếp
> theo đúng mục "Chất lượng biên tập" của checklist tương ứng (với SEO là mục 6 của
> `seo_checklist.md`; Factory khác áp dụng đúng tinh thần này dù checklist của họ đặt tên mục
> khác) — đây là phần bắt buộc của bước đọc lại, không còn là tự kiểm tùy chọn. Tìm đoạn nào đọc
> còn nhạt/chung chung/sáo rỗng, câu nào nghe rõ là AI viết, chỗ nào ý bị lặp lại, mở bài/kết bài
> có đủ cuốn người đọc chưa, ví dụ có đủ cụ thể/sống động chưa. Thấy chỗ nào nhạt hoặc sai thì
> **viết lại ngay tại chỗ đó**, không chỉ liệt kê ra rồi để nguyên. Không lưu nội dung "đúng
> checklist kỹ thuật là đủ" rồi để một bài nhạt, lặp ý, hoặc đọc chán lọt qua — đọc lại mà không
> tìm ra gì để sửa thường là dấu hiệu đang đọc lướt, không phải dấu hiệu bài đã hoàn hảo.
