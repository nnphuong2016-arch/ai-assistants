...
## MẪU B — THUMBNAIL BÀI VIẾT

- **Dùng cho:** ảnh đại diện bài blog trên trang danh sách.
- **Aspect Ratio mặc định:** 16:9.
- Một chủ thể rõ ràng, không chữ chèn cứng vào ảnh (tiêu đề do theme tự hiển thị đè lên).
...
## MẪU E — BLOG COVER (Open Graph)

- **Dùng cho:** ảnh chia sẻ khi bài được đăng lên mạng xã hội (OG Image).
