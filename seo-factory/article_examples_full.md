# ARTICLE EXAMPLES FULL — BÀI MẪU HOÀN CHỈNH THEO KHUÔN

> Tải lên khu **Files** của SEO Factory. File này chứa bài mẫu VIẾT ĐẦY ĐỦ (không phải outline)
> theo đúng `article_templates.md` + `web_content_rules.md` + `output_schema.md` — dùng để đối
> chiếu khi thấy bài đang viết bị mỏng, thiếu chiều sâu, hoặc lệch khuôn.
...
Backlog chủ đề gốc (danh sách 1 dòng trong `bai-seo-dang-website-Anh-Minh.md`, gốc repo
`ai-assistants/` — xem `CLAUDE.md` Bước 2) chỉ là **input chủ đề**, không phải bài đã hoàn chỉnh. Ba bài
dưới đây minh họa khoảng cách giữa một dòng outline ("Cơ thể thích sự đều đặn hơn những cố gắng
nhất thời.") và một bài SEO thật sự "lưu giữ kiến thức" — có mở trả lời thẳng, H2 đào sâu từng
góc, FAQ, và gợi ý áp dụng cụ thể.

---

## BÀI MẪU 1 — MẪU A (Explainer), trụ Sức khỏe, Standard (~1200 từ)

**Title:** Ngủ đủ vẫn mệt: vì sao nhịp ngủ quan trọng hơn số giờ?
**Slug:** nhip-ngu-deu-dan
**Meta Description:** Ngủ đủ giờ mà vẫn mệt vì nhịp ngủ chưa đều. Bài viết lý giải vì sao sự đều đặn quan trọng hơn số giờ ngủ, và cách xây một nhịp ngủ dễ chịu mỗi ngày.
**Excerpt:** Ngủ đủ giờ nhưng vẫn mệt? Có thể vấn đề không nằm ở số giờ, mà ở nhịp ngủ-thức mỗi ngày.
**Category:** Sức khỏe
**Tags:** giấc ngủ, nhịp ngủ, dưỡng sinh, thói quen buổi tối, sức khỏe tuổi trung niên
...
## BÀI MẪU 2 — MẪU C (Suy ngẫm triết), trụ Triết lý phương Đông, Standard

**Title:** Biết đủ là gì – vì sao Lão Tử gọi đó là giàu có?
**Slug:** biet-du-la-giau-co
**Meta Description:** Lão Tử nói "biết đủ là giàu". Bài viết lý giải ý nghĩa của biết đủ theo góc Đạo gia, và cách nhận ra mình đã đủ giữa nhịp sống hôm nay.
**Excerpt:** Biết đủ không phải là ngừng cố gắng — mà là một cách nhìn khiến lòng nhẹ hơn giữa những ham muốn không có điểm dừng.
**Category:** Triết lý phương Đông
**Tags:** biết đủ, tri túc, Lão Tử, triết lý sống, an nhiên, lối sống chậm
...
## BÀI MẪU 3 — MẪU E (Bài trụ Pillar), trụ Dưỡng sinh (~1800 từ)

**Title:** Dưỡng sinh: vì sao lối sống đều đặn giúp khỏe bền hơn?
**Slug:** duong-sinh-loi-song-deu-dan
**Meta Description:** Dưỡng sinh không phải sống khổ hạnh hay uống nhiều thuốc bổ. Bài viết tổng quan lối sống dưỡng sinh: giấc ngủ, ăn uống, vận động, nghỉ ngơi đều đặn giúp cơ thể bền hơn theo thời gian.
**Excerpt:** Dưỡng sinh không nằm ở một phương pháp cấp tốc nào — mà ở việc chọn một nhịp sống đều đặn, ngày này qua ngày khác.
**Category:** Dưỡng sinh
**Tags:** dưỡng sinh, lối sống điều độ, sức khỏe tuổi trung niên, thói quen lành mạnh, nhịp sống chậm, người xưa dưỡng sinh
...
2. Ăn chậm, ăn đúng giờ: điều nhỏ mà cơ thể nhớ lâu *(chưa viết — chủ đề gợi ý)*
3. Vận động nhẹ mà đều: vì sao bền hơn tập nặng rồi bỏ giữa chừng *(chưa viết — chủ đề gợi ý)*
4. Người xưa dưỡng sinh không bắt đầu từ thuốc *(chưa viết — chủ đề gợi ý)*

---

## TÓM TẮT CÁCH DÙNG 3 BÀI MẪU

Mô hình **Bài trụ (Mẫu E) → Bài vệ tinh (Mẫu A, C, ...)**: bài trụ trả lời "lối sống ảnh hưởng
thế nào tới [chủ đề lớn]", các bài vệ tinh đào sâu từng khía cạnh cụ thể. Khi nhận một dòng
outline từ backlog, tự hỏi: dòng này nên là bài vệ tinh (đào sâu MỘT khía cạnh) hay là chất liệu
cho một H2 trong bài trụ (một góc trong bức tranh tổng)? Không phải outline nào cũng cần thành
một bài riêng — nhiều outline gộp lại vừa đủ làm một H2.
