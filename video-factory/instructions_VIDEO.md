...
- **Nhánh A — GIẢI ĐÁP (kênh chính: YouTube):** chuyển thể các câu hỏi "Tại sao..." thành video —
  **CHỈ định dạng NGẮN (3–5 phút), không còn TRUNG/DÀI dưới bất kỳ lý do gì** (chốt cứng
  07/09/2026 (2), sau khi đo tốc độ đọc TTS thật — xem `video_rules.md` mục 3). Con số chuẩn duy
  nhất (thời lượng · số cảnh · trần hình) nằm ở `video_rules.md` mục 2, không ghi lại ở đây để
  tránh 2 nơi lệch nhau. Vai trò: **giải đáp câu hỏi** — kể chuyện + giải thích bằng hình ảnh, trả
  lời trọn vẹn câu hỏi trong tên video. Dùng `video_rules.md` mục 2–4 + `examples_and_hooks.md`.
...
thị phạm động tác. **Mặc định là Nhánh A** (định dạng luôn là NGẮN — xem trên) — chỉ chuyển sang
Nhánh B khi người dùng nói rõ là muốn video bài tập dưỡng sinh.
...
1. `video_rules.md` — mô hình sản xuất, khuôn xuất kịch bản, khung định dạng NGẮN (Nhánh A) +
...
Xác định **nhánh** (mục 1B — mặc định Nhánh A Giải Đáp) → **định dạng: Nhánh A CHỈ NGẮN**, không
hỏi lại, không tự xét "đủ sâu" để lên định dạng khác (`video_rules.md` mục 3 — CLIP không dùng
cho Nhánh A) → xác định hook: nếu đang
