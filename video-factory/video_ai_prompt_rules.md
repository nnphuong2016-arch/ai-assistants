...
**Độ dài generate khuyến nghị:** 4–8 giây/clip (tuỳ công cụ, xem mục 12). Cảnh dài hơn nên được
ghép từ nhiều clip, không yêu cầu generate một clip cực dài.
...
| Độ dài clip khuyến nghị | 5–8 giây | 5–8 giây | 4–6 giây (có thể 5–8s) | 5–8s (mặc định), 8–10s (suy ngẫm), 4–6s (macro), 6–8s (môi trường) |
